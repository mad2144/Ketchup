...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { email: @trainer.email, first_name: @trainer.first_name, last_name: @trainer.last_name }
    end
  ...
  test "should update trainer" do
    put :update, id: @trainer, trainer: { email: @trainer.email, first_name: @trainer.first_name, last_name: @trainer.last_name }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
